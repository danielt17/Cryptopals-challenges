...
from sets.set_05_diffie_hellman_and_friends.challenge_33_diffie_hellman.diffie_hellman import modexp
from sets.set_06_rsa_and_dsa.challenge_47_pkcs1_v1_5_padding_oracle.pkcs1_v1_5_padding_oracle_rsa256 import ceil,append_and_merge
from Crypto.Util.number import long_to_bytes
import sys
from time import sleep
from pwn import hexdump
import socket
from sets.set_06_rsa_and_dsa.challenge_48_bleichenbacher_98.client import AESCBC,SHA1_MAC
...
class MITM:
    ...
    def receive_from_alice_send_to_bob_and_receive_send_back_to_alice(self,alice_socket, bob_socket):
        """Convert receive from alice send to bob and receive send back to alice."""
    ...
    def decrypt_data_check_authentication(self,cipherText,iv,mac):
        """Decrypt data check authentication."""

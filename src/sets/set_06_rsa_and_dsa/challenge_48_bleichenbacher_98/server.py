...
from sets.set_06_rsa_and_dsa.challenge_47_pkcs1_v1_5_padding_oracle.pkcs1_v1_5_padding_oracle_rsa256 import RSAPCKS1PaddingOracle
...
class SERVER:
    ...
    def send_response_to_client(self,client_socket,data):
        """Convert send response to client."""

...
from sets.set_05_diffie_hellman_and_friends.challenge_39_rsa_implementation.rsa_implementation import generate_prime_number,invmod,generate_prime_candidate
...
def generate_prime_number_given_condition(q,length=1024):
    """Generate prime number given condition."""

...
from sets.set_05_diffie_hellman_and_friends.challenge_39_rsa_implementation.rsa_implementation import invmod
from sets.set_06_rsa_and_dsa.challenge_43_dsa_key_recovery_from_nonce.dsa_key_recovery_from_nonce import attack_on_dsa_fixed_nonce
...
def load_data():
    """Load data."""
    with Path(__file__).with_name('64.txt').open('r', encoding='utf-8') as f:
        lines = f.readlines()
    data = []
    print('Recieved data: \n')

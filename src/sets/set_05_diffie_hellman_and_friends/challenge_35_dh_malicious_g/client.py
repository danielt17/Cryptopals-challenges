# -*- coding: utf-8 -*-
"""
Created on Fri Oct  8 14:02:37 2021
...
from sets.set_05_diffie_hellman_and_friends.challenge_33_diffie_hellman.diffie_hellman import DiffieHellman
from Crypto.Random import get_random_bytes
from sets.set_04_stream_crypto_and_randomness.challenge_28_sha1_keyed_mac.sha1_keyed_mac import SHA1
from binascii import unhexlify
from sets.set_02_block_crypto.challenge_16_cbc_bitflipping.cbc_bitflipping import aes_cbc_encrypt,aes_cbc_decrypt
...
class CLIENT:
    ...
    def valid_request(self,request):
        ...
        """
        commands = ['GET_CIPHER_SUIT','AGREED_CIPHER_SUIT','SEND_PUBLIC_INFO','SEND_PUBLIC_KEY','SEND_ENCRYPTED','EXIT']
    ...
    def send_request_to_server(self,my_socket, request):
        ...
        elif request == 'SEND_PUBLIC_INFO':
            data = data + ' ' + 'p=' + str(self.p) + '&' + 'g=' + str(self.g)
        elif request == 'SEND_PUBLIC_KEY':
            data = data + ' ' + 'A=' + str(self.A)
    ...
    def handle_server_response(self,my_socket, request):
        ...
        if request == 'GET_CIPHER_SUIT' or request == 'AGREED_CIPHER_SUIT' or request == 'SEND_PUBLIC_INFO' or request == 'SEND_PUBLIC_KEY' or request == 'SEND_ENCRYPTED':
...
def main():
    ...
    for g in gs:
        ...
        print('Send p, g \n')
        client.send_and_recive(my_socket, 'SEND_PUBLIC_INFO')
        print('Send A \n')

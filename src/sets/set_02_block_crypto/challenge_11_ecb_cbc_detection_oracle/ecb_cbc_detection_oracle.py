...
import numpy as np
from sets.set_02_block_crypto.challenge_10_cbc_mode.cbc_mode import aes_ecb_encrypt_padded,aes_cbc_encrypt
# %% Functions

def encryption_oracle_ecb_cbc(input_text):
    """Compute encryption oracle ecb cbc."""

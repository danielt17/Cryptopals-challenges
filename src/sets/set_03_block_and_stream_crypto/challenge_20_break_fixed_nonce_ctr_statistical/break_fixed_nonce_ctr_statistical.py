...
from sets.set_03_block_and_stream_crypto.challenge_19_break_fixed_nonce_ctr.break_fixed_nonce_ctr import AESCTRFixedNonceOracle,encrypt_plaintexts,attack_ctr_using_substitutions,reconstruct_plaintexts,comparison_one_by_one
import numpy as np
...
def load_plain_texts():
    """Load plain texts."""
    lines = []
    with Path(__file__).with_name('34.txt').open('r', encoding='utf-8') as f:
        lines = f.readlines()

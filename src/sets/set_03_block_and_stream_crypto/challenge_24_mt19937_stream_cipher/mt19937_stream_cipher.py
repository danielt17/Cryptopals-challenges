...
from sets.set_03_block_and_stream_crypto.challenge_21_mt19937_rng.mt19937_rng import MT19937MersenneTwisterRNG as MT19937
import numpy as np
...
def brute_force_mt19937_stream_cipher_seed(cipherText,knownText):
    """Brute force mt19937 stream cipher seed."""

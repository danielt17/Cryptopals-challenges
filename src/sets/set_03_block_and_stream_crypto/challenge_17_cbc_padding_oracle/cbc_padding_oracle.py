...
if __name__ == '__main__':
    ...
    if Oracle.decrypt(cipherText) == plainText:
        ...
        print('Decrypted cipher text: ' + str(b64decode(Oracle.decrypt(cipherText)))[8:-1] + '.')
        print('Padding oracle attack decryption: ' + str(b64decode(plainText))[8:-1] + '.')
    else:

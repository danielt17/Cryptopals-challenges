...
from sets.set_01_basics.challenge_03_single_byte_xor_cipher.single_byte_xor_cipher import BruteForceSingleByteXorCipher
...
if __name__ == '__main__':
    lines = []
    with Path(__file__).with_name('14.txt').open('r', encoding='utf-8') as f:
        lines = f.readlines()
